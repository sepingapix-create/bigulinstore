      ...
      <section className="py-8 border-t border-border/40 bg-card/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6">
            ...
            <OpenJivoButton className="group p-5 rounded-3xl bg-muted/20 border border-border/50 hover:border-green-500/50 hover:bg-green-500/5 hover:text-green-500 transition-all duration-500 hover:-translate-y-2 shadow-xl hover:shadow-green-500/20">
              <svg 
                viewBox="0 0 24 24" 
