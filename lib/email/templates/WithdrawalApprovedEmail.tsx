  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ color: "#68d888", fontSize: "26px", fontWeight: "900", margin: "0 0 4px" }}>
          Saque Aprovado!
        </Text>
        <Text style={{ color: "#a8c8b8", fontSize: "15px", margin: "0" }}>
      ...
      <Text style={sharedStyles.body_text}>
        Sua solicitação de saque foi <strong style={{ color: "#68d888" }}>aprovada</strong> pela
      ...
      <InfoBox color="#4ad868">
        ...
        <Text style={{ color: "#c8e8c8", fontSize: "14px", margin: "0 0 4px" }}>
          Valor: <strong style={{ color: "#68d868", fontSize: "16px" }}>{formatCurrency(amount)}</strong>
        </Text>
        <Text style={{ color: "#c8e8c8", fontSize: "14px", margin: "0 0 4px" }}>
          Chave PIX ({pixKeyType}): <strong style={{ color: "#f8f8f8" }}>{pixKey}</strong>
        </Text>
        <Text style={{ color: "#8888a8", fontSize: "12px", margin: "8px 0 0" }}>
      ...
      <Text style={{ ...sharedStyles.body_text, fontSize: "13px", color: "#6868a8" }}>
        Obrigado por fazer parte do programa de afiliados Bingulin!
